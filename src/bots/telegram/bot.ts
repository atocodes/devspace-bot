...
import { actions, TOPICHANDLER } from "./handlers/actions";
...
import { stage, STARTMANUALPOSTCONVERSATION } from "./conversations/createManualPost";
...
topicNamesList.forEach((topic) => {
  bot.action(topic, TOPICHANDLER);
});
